...
<svg
	...
	{...props}
	class={props.class}
	><!-- Icon from Flowbite Icons by Themesberg - https://github.com/themesberg/flowbite-icons/blob/main/LICENSE --><g
		fill="currentColor"
		><path
			fill-rule="evenodd"
			...
			clip-rule="evenodd"
		/><path d="M19 13h-2v2h2zM13 3h-2v2h2zm-2 2H9v2h2zM9 3H7v2h2zm12 8h-2v2h2zm0 4h-2v2h2z" /></g
	></svg
>
